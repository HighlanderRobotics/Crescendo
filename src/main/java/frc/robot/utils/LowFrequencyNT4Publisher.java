// Copyright 2021-2024 FRC 6328 and FRC 8033
...
public class LowFrequencyNT4Publisher implements LogDataReceiver {
  ...
  public LowFrequencyNT4Publisher(double frequency) {
  ...
  public void putTable(LogTable table) {
    if (table.getTimestamp() < lastUpdate + (1e6 / frequency)) return;
    lastUpdate = table.getTimestamp();
    // Send timestamp
