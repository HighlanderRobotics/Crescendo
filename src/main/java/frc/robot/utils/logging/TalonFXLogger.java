...
/** Helper class for logging TalonFX data with advantagescope. 
 * This logs talonFX data using either rotations or meters, depending on how the mechanism is configured.
*/
public class TalonFXLogger {
    ...
    public TalonFXLogger(TalonFX talon, double updateFrequencyHz, boolean shouldOptimizeBusUsage) {
        ...
        BaseStatusSignal.setUpdateFrequencyForAll(updateFrequencyHz, voltageSignal, statorCurrentSignal, supplyCurrentSignal, temperatureSignal, rotationSignal, velocitySignal);
