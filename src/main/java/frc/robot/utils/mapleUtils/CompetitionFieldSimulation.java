...
import frc.robot.utils.mapleUtils.Objects.GamePieceInSimulation;
...
public abstract class CompetitionFieldSimulation {
  ...
  public CompetitionFieldVisualizer getCompetitionField() {
    return competitionField;
  }

  public HolonomicChassisSimulation getMainRobot() {
    return mainRobot;
  }
  ...
  public abstract static class FieldObstaclesMap {
    ...
    protected void addRectangularObstacle(double width, double height, Pose2d pose) {
      final Body obstacle = getObstacle(Geometry.createRectangle(width, height));
