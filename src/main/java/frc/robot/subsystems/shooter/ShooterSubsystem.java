...
public class ShooterSubsystem extends SubsystemBase {
  ...
  public boolean isAtGoal() {
    return MathUtil.isNear(rotationGoal.getDegrees(), inputs.pivotRotation.getDegrees(), 0.5)
        && MathUtil.isNear(leftGoal, inputs.flywheelLeftVelocityRotationsPerSecond, 2.0)
        && MathUtil.isNear(rightGoal, inputs.flywheelRightVelocityRotationsPerSecond, 2.0);
  }
}
