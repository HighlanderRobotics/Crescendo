...
public class LEDSubsystem extends SubsystemBase {
  ...
  public Command defaultStateDisplayCmd(
      BooleanSupplier enabled, BooleanSupplier inRange, BooleanSupplier inNeutral, Supplier<Target> target) {
    return Commands.either(
            Commands.select(
                Map.of(
                    ...
                    Target.FEED,
                    this.setBlinkingCmd(() -> new Color("#0000ff"), () -> inNeutral.getAsBoolean() ? new Color("#00ff00") : new Color(), 10.0)
