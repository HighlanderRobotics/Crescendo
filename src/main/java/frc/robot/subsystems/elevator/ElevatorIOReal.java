...
public class ElevatorIOReal implements ElevatorIO {
    ...
    public ElevatorIOReal() {
        ...
        config.MotionMagic.MotionMagicCruiseVelocity = 50.0 / (ElevatorSubsystem.GEAR_RATIO * 2 * Math.PI * ElevatorSubsystem.DRUM_RADIUS_METERS);

        // Carriage position meters in direction of elevator
        config.Feedback.SensorToMechanismRatio = ElevatorSubsystem.GEAR_RATIO * 2 * Math.PI * ElevatorSubsystem.DRUM_RADIUS_METERS;
