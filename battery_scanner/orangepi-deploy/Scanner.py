...
parser.add_argument("--dev", default="/dev/ttyACM0", type=str, help="Path to the camera device")
...
# Setup Pynetworktables
NetworkTables.initialize(server="roborio-8033-frc.local")
...
sd = NetworkTables.getTable("/AdvantageKit")
sd.putString('battery_name', name if name != "" else "somecoolbatteryidcuzwecantfindthebatteryidandwearenowverysad")
